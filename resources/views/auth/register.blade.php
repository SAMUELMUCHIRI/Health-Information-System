    ...
    <div class="bg-white dark:bg-gray-900">
        <div class="flex justify-center h-screen  w-full ">
            <div class="hidden  lg:block lg:w-2/3 h-full flex items-end relative " >
                <img src="public/images/register.webp" alt="doctor.webp" loading="eager" class="dark:brightness-50 brightness-70 h-full object-cover object-top-right w-full absolute z-0">                   
