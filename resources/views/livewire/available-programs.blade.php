<div wire:poll.2s>
    <div class="flex flex-1 flex-col gap-2 ">
        ...
        <div  class="flex-1 p-2  flex flex-col rounded dark:bg-gray-50 bg-gray-200  ">
            ...
            <div class="flex flex-row flex-1 gap-1 w-full justify-between">
                <div>
                <p>Program Number</p>
                <p> {{$program->program_number}}</p>
                </div>
                <flux:button wire:click="assign({{$program->id}})" variant="primary" size="sm" class="w-auto">Enroll</flux:button>
